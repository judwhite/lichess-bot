...
func analysis() {
	...
	/*const fenString = "r1bqkbnr/1p2pppp/p1n5/8/8/2N5/PP1PPPPP/R1BQKBNR w KQkq - 0 5"
	if err := a.AnalyzePosition(context.Background(), fenString); err != nil {
		log.Fatal(err)
	}*/
	...
	if err := a.AnalyzeGame(context.Background(), moves, 32, 30*time.Minute); err != nil {
		log.Fatal(err)
	}
